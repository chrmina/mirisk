...
$htmlFile = dirname(__FILE__) . $file;
...
$defaultDomain = 'mirisk.dum.kyoto-u.ac.jp';
// Full path to the PDF we are creating
$pdfFile = dirname(__FILE__) . '/pdfout/zzz.pdf';
...
$pdf->setFooter('left', 'Generated by MIRISK');
