...
$graph->title->Set("PGA-MDF Relation for Runways");
...
$lineplotRunway = new LinePlot($ydata,$xdata);
$lineplotRunway->SetWeight(2);
$lineplotRunway->SetColor("blue");

// Add plots to the graph
$graph->Add($lineplotRunway);
