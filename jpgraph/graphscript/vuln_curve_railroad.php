...
$graph->title->Set("PGA-MDF Relation for Railroad(Roadbed)");
...
$lineplotRailroad = new LinePlot($ydata,$xdata);
$lineplotRailroad->SetWeight(2);
$lineplotRailroad->SetColor("blue");

// Add plots to the graph
$graph->Add($lineplotRailroad);
