...
$graph->title->Set("PGA-MDF Relation for Elect.Substations(>100kv)");
...
$lineplotElectSub = new LinePlot($ydata,$xdata);
$lineplotElectSub->SetWeight(2);
$lineplotElectSub->SetColor("blue");

// Add plots to the graph
$graph->Add($lineplotElectSub);
